...
def _read_raganato_xml(
    ...
    print("Type of readby: ", type(read_by), read_by)

    print("RaganatoReadBy: ", type(RaganatoReadBy), RaganatoReadBy)
...
class WSDDataset(FairseqDataset):
    ...
    def read_raganato(
        ...
        read_by = read_by(xml_path)
        print("readby in read_raganato", read_by)
        #detect lang
...
#%%
# senseval2 = "C:/Users/HP/PycharmProjects/RSM4WSD/resources/EvaluationDatasets/eval_datasets/senseval2/senseval2.data.xml"
# #%%
#
# # print(next(read_by_text_iter(senseval2)))
# s = read_by_sent_iter(senseval2)
# for i in s:
#     print(type(i), i)
#     for it in i[1].iter():
#         # print("attrib type", type(it.attrib))
#         # print("items", type(it.attrib.items()))
#         print(it.attrib) # dict--> attrib, dict_items--> dictionary items
#         break
#%%
# cl = RaganatoReadBy.SENTENCE(senseval2)
# print(cl)
# for i in cl:
#     print(i)
#     for it in i[1].iter():
#         print(it.attrib.items())
#%%
# dictionary = Dictionary.load(DEFAULT_DICTIONARY)
# #%%
# if senseval2.endswith('.data.xml'):
