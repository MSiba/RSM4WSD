...
output_info = '../data/training_datasets/pwngc4torchtext.csv'
instances = pickle.load(open('./data/ulm/instances.bin', 'rb'))
#%%
df_path = "./data/wordnet_dataframes/SPATIAL_WORDNET.pickle"
...
with open(output_info, 'w') as infofile:
    for instance_id, instance in instances.items():
        ...
        for (target_lemma,
            ...
            synset_name = synset_name(clean_offset(token_annotation))
            # synset_coordinates =
            row = [sentence_tokens[target_index], target_lemma, target_pos, clean_offset(token_annotation), synset_name(clean_offset(token_annotation))]
